/*!
 * This file defines the interface to the main controller for the
 * Stack model.  More general functionality that involves manipulating
 ...
 * the Stack model.  Other than the Stack, this controller contains
 * no state currently.  This will change when a view is created.
*/
class StackController {
  public:
     ...
     * \param stack_ Stack
    */
    StackController(Stack* stack_) : stack(stack_) {}

    /*!
     * Retrieves the stack stored in the controller
